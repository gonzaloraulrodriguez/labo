...
kdataset_salida  <- "paquete_premium_ext_721_L1_2.csv.gz"
...
#calculo la media movil, ventana de 4 meses  para las columnas  cols_laguables
dataset[  , paste0( cols_lagueables, "_mean4") :=  frollmean( .SD, n= 4L, align='right', na.rm= TRUE ), 
          by= numero_de_cliente,
          .SDcols= cols_lagueables ]
#calculo la media movil, ventana de 2 meses  para las columnas  cols_laguables
