...
dataset[ , train  := 0L ]
dataset[ foto_mes >= 201911 & foto_mes<=202011 & foto_mes != 202006, 
         train  := 1L ]

#--------------------------------------
#creo las carpetas donde van los resultados
dir.create( "./exp/",  showWarnings = FALSE ) 
dir.create( "./exp/KA7100-2019/", showWarnings = FALSE )
setwd( "./exp/KA7100-2019/" )
...
archivo_importancia  <- "710_importancia_LAG1_2019_001.txt"
...
for( envios  in  c( 10000, 10500, 11000, 11500, 12000, 12500, 13000, 13500 ) )
{
  ...
  fwrite( tb_entrega[ , list(numero_de_cliente, Predicted)], 
          file= paste0( "KA_710_LAG1_2019_", envios, ".csv" ),
          sep= "," )
}
