...
setwd("C:\\Users\\Gonzalo\\Desktop\\MMD\\8- Mineria Aplicada a Finanzas\\Git Clone\\labo\\")  #Establezco el Working Directory
...
param_buenos  <- list( "cp"=         -200978883281915,
                       "minsplit"=  2096,
                       "minbucket"= 515,
                       "maxdepth"=    9)

num_trees         <-  20#20    #voy a generar 20 arboles, a mas arboles mas tiempo de proceso y MEJOR MODELO
...
dir.create( "C:\\Users\\Gonzalo\\Desktop\\MMD\\8- Mineria Aplicada a Finanzas\\Git Clone\\labo\\exp\\KA2101", showWarnings = FALSE )

#aqui es donde voy a graficar los arboles
pdf( "C:\\Users\\Gonzalo\\Desktop\\MMD\\8- Mineria Aplicada a Finanzas\\Git Clone\\labo//exp//KA2101/arbolitos.pdf", paper="a4r" )
...
fwrite( tb_ensembles,
        file="C:\\Users\\Gonzalo\\Desktop\\MMD\\8- Mineria Aplicada a Finanzas\\Git Clone\\labo\\exp\\KA2101/ensemble.csv",
        sep="\t" )
...
fwrite( entrega, 
        file= "C:\\Users\\Gonzalo\\Desktop\\MMD\\8- Mineria Aplicada a Finanzas\\Git Clone\\labo\\exp\\KA2101/K311_001.csv", 
        sep= "," )
