...
hs  <- makeParamSet(
          makeIntegerParam("num.trees" ,        lower=  1L, upper= 2500L),  #la letra L al final significa ENTERO
          makeIntegerParam("max.depth",         lower=    1L, upper=   25L),  # 0 significa profundidad infinita
          makeIntegerParam("min.node.size" ,    lower=    1L, upper=  5000L),
          makeIntegerParam("mtry" ,             lower=    2L, upper=   100L))
...
dataset  <- fread("C:\\Users\\Gonzalo\\Desktop\\MMD\\8- Mineria Aplicada a Finanzas\\Datasets/paquete_premium_202011.csv", stringsAsFactors= TRUE)   #donde entreno

#creo la carpeta donde va el experimento
# HT  representa  Hiperparameter Tuning

dir.create( "C://Users//Gonzalo//Desktop//MMD//8- Mineria Aplicada a Finanzas//Git Clone//labo///exp/",  showWarnings = FALSE ) 
dir.create( "C://Users//Gonzalo//Desktop//MMD//8- Mineria Aplicada a Finanzas//Git Clone//labo///exp//HT4330/", showWarnings = FALSE )
setwd("C://Users//Gonzalo//Desktop//MMD//8- Mineria Aplicada a Finanzas//Git Clone//labo///exp//HT4330\\")   #Establezco el Working Directory DEL EXPERIMENTO
